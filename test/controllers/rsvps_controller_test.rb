...
class RsvpsControllerTest < ActionController::TestCase
  ...
  test "should create rsvp" do
    assert_difference('Rsvp.count') do
      post :create, rsvp: { ceremony: @rsvp.ceremony, diner: @rsvp.diner, name1: @rsvp.name1, name2: @rsvp.name2, reception: @rsvp.reception }
    end
  ...
  test "should update rsvp" do
    patch :update, id: @rsvp, rsvp: { ceremony: @rsvp.ceremony, diner: @rsvp.diner, name1: @rsvp.name1, name2: @rsvp.name2, reception: @rsvp.reception }
    assert_redirected_to rsvp_path(assigns(:rsvp))
  end
